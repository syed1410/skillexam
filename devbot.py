...
if choice == "N" or choice == "n":
	...
	accessToken = "Bearer OWJhMGM1MmUtZjI4OC00Mzk0LWFjNDMtZWIwZTJhZjE2Y2M4MGViNjQ2OTQtZmY2_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "TsD0PVSK556RxhwV3nZpLsdj8q7S5hMO"
                               }
# 7. Provide the URL to the MapQuest GeoCode API.
        r = requests.get("https://www.mapquestapi.com/geocoding/v1/address?key=TsD0PVSK556RxhwV3nZpLsdj8q7S5hMO&location=Sudbury,ON", 
...
# 11. Complete the code to format the response message.
        responseMessage = "In {Sudbury,ON} the sun will rise at {7:13:40 AM} and will set at {4:47:25 PM} . The day will last {09:26:15} seconds.".format(locationResults, risetimeInFormattedString, durationInSeconds)
